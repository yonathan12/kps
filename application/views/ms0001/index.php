...
<div class="modal fade" id="editSiswa" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <div class="modal fade" id="upload" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document" style="margin-top:100px;">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title" id="myModalLabel">Import Data SIswa</h4>

			</div>
        	<div>
			<?php echo form_open_multipart("MS0001/upload",'class="form-horizontal"'); ?>
				<div class="modal-body">
					<div class="form-group row">
					<div class="col-md-12">
						<label for="exampleInputFile">Pilih File Excel</label>
							<?= form_upload(array('id' => 'txtFileImport', 'name' => 'file'))?>
							<small id="fileImport" class="form-text text-muted">Import Data Siswa Via Excel, Format File Harus .XLSX</small>
					</div>
					</div>
				</div>
				<div class="modal-footer">
